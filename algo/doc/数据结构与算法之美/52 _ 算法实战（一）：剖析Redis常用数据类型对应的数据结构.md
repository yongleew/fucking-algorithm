<audio title="52 _ 算法实战（一）：剖析Redis常用数据类型对应的数据结构" src="https://static001.geekbang.org/resource/audio/90/1b/90b62c1ae6eda4633470f65032c1281b.mp3" controls="controls"></audio> 
